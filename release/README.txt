...
This is a release of SkyrimNetMeesagelessImmersion mod.
This whole things will NOT DO ANYTHING AT ALL unless you have SykrimNet installed and working on your system.

Version 0.6.13 and higher support both SkyrimNet beta25-RC6 and earlier (beta24) as well as the new beta25-RC7/RC8 content layout. Both layouts are included and SkyrimNet automatically uses the appropriate one; no installer choice or manual migration is required.
