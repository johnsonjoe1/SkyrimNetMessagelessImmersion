	...
	if (fatigueGV) {
		...
		if (fatigue == 0) {
			...
			if (fatigue > previous_iNeed_fatigue_level) {
				DumpThoughts::throw_out_BACKGROUND_TTS_thought_message(std::format("You are feeling mild fatigue.  Say so in your response and let us know how that makes you feel!  And make it clear that you speak about your fatigue in your response!"));
			...
			if (fatigue > previous_iNeed_fatigue_level) {
				DumpThoughts::throw_out_BACKGROUND_TTS_thought_message(std::format("You are feeling moderate fatigue.  Say so in your response and let us know how that makes you feel!  And make it clear that you speak about your fatigue in your response!"));
			...
			if (fatigue > previous_iNeed_fatigue_level) {
				DumpThoughts::throw_out_BACKGROUND_TTS_thought_message(std::format("You are feeling severe fatigue!  This is not just a little bit, but really severe fatigue that is impairing your abilities.  Say so in your response and let us know how that makes you feel!  And make it clear that you speak about your fatigue in your response!"));
	...
	if (thirstGV) {
		...
		if (thirst == 0) {
			...
			if (thirst < previous_iNeed_thirst_level) {
				DumpThoughts::throw_out_BACKGROUND_TTS_thought_message(std::format("You completely rid of your thirst now!  Say so in your response and let us know how that makes you feel!  And make it clear that you speak about your thirst in your response!"));
			...
			if (thirst > previous_iNeed_thirst_level) {
				DumpThoughts::throw_out_BACKGROUND_TTS_thought_message(std::format("You are feeling mild thirst.  Say so in your response and let us know how that makes you feel!  And make it clear that you speak about your thirst in your response!"));
			...
			if (thirst > previous_iNeed_thirst_level) {
				DumpThoughts::throw_out_BACKGROUND_TTS_thought_message(std::format("You are feeling moderate thirst.  Say so in your response and let us know how that makes you feel!  And make it clear that you speak about your thirst in your response!"));
			...
			if (thirst > previous_iNeed_thirst_level) {
				DumpThoughts::throw_out_BACKGROUND_TTS_thought_message(std::format("You are feeling severe thirst!  This is not just a little bit, but really severe thirst that is impairing your abilities.  Say so in your response and let us know how that makes you feel!  And make it clear that you speak about your thirst in your response!"));
	...
	if (hungerGV) {
		...
		if (hunger == 0) {
			...
			if (hunger < previous_iNeed_hunger_level) {
				...
				DumpThoughts::throw_out_BACKGROUND_TTS_thought_message(std::format("You are completely rid of your hunger now!  Say so in your response and let us know how that makes you feel!  And make it clear that you speak about your hunger in your response!"));
			}							
		} else if (hunger == 1) {
			logger::info(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>iNeed hunger GlobalVariable found: i guess that means MILD hunger! ");
			if (hunger > previous_iNeed_hunger_level) {
				DumpThoughts::throw_out_BACKGROUND_TTS_thought_message(std::format("You are feeling mild hunger.  Say so in your response and let us know how that makes you feel!  And make it clear that you speak about your hunger in your response!"));
			...
			if (hunger > previous_iNeed_hunger_level) {
				...
				DumpThoughts::throw_out_BACKGROUND_TTS_thought_message(std::format("You are feeling moderate hunger.  Say so in your response and let us know how that makes you feel!  And make it clear that you speak about your hunger in your response!"));
			}				
		} else if (hunger == 3) {
			...
			if (hunger > previous_iNeed_hunger_level) {
				...
				DumpThoughts::throw_out_BACKGROUND_TTS_thought_message(std::format("You are feeling severe hunger!  This is not just a little bit, but really severe hunger that is impairing your abilities.  Say so in your response and let us know how that makes you feel!  And make it clear that you speak about your hunger in your response!"));
			}				
		} else {
