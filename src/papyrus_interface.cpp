...
void SNMIPapyrus::suppress_next_Apropos2_state_updates()
{
	_suppress_next_Apropos2Vstate_update = true;
	_suppress_next_Apropos2Astate_update = true;
	_suppress_next_Apropos2Ostate_update = true;
}

void SNMIPapyrus::set_Apropos2Vstate(RE::StaticFunctionTag*, float a_value)
{
	if (_suppress_next_Apropos2Vstate_update) {
		_suppress_next_Apropos2Vstate_update = false;
		previous_Apropos2Vstate = a_value;
...
{
	if (_suppress_next_Apropos2Astate_update) {
		_suppress_next_Apropos2Astate_update = false;
		previous_Apropos2Astate = a_value;
...
{
	if (_suppress_next_Apropos2Ostate_update) {
		_suppress_next_Apropos2Ostate_update = false;
		previous_Apropos2Ostate = a_value;
